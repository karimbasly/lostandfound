    ...
    a.extend(b.prototype, {
        ...
        a
          ? (this.loadingTimeout = setTimeout(function () {
              b.$el.addClass(b.options.elementLoadingClass),
                b.$content.html('<p class="slbLoadingText ' + b.options.loadingTextClass + '">' + b.options.loadingCaption + '</p>'),
                b.show();
      ...
      prepareItem: function (b, c) {
        ...
        if ((this.loading(!0), this.options.videoRegex.test(e)))
          c.call(
            d,
            a('<div class="slbIframeCont"><iframe class="slbIframe" frameborder="0" allowfullscreen src="' + e + '"></iframe></div>')
          );
        else {
      ...
      setContent: function (b) {
        ...
        return (
          ...
          this.options.beforeSetContent && this.options.beforeSetContent(c, this),
          this.$content.html(c),
          this
        );
      },
        ...
        this.lightboxEventsSetuped ||
          ...
          e.on('keyup' + this.ens, function (a) {
            b.options.closeOnEscapeKey && 27 === a.keyCode && b.close(),
              b.items.length > 1 &&
                ((39 === a.keyCode || 68 === a.keyCode) && b.next(), (37 === a.keyCode || 65 === a.keyCode) && b.prev());
          }),
