(function (a) {
  ...
  var g = function (k, j) {
    ...
    this.format = c.parseFormat(
      j.format || this.element.data('date-format') || e[this.language].format || c.getDefaultFormat(this.formatType, 'input'),
      this.formatType
    );
    this.isInline = false;
    ...
    this.linkFormat = c.parseFormat(
      j.linkFormat || this.element.data('link-format') || c.getDefaultFormat(this.formatType, 'link'),
      this.formatType
    );
