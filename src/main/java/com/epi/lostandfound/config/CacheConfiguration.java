package com.epi.lostandfound.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.epi.lostandfound.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.epi.lostandfound.repository.UserRepository.USERS_BY_EMAIL_CACHE);
